...
import { Button, DocumentTitle, PasswordFieldOutlined, TextFieldOutlined } from '~/components'
  ...
  return (
    <>
      ...
      <div className="w-full lg:w-[700px] xl:w-full h-full grid xl:grid-cols-2">
        <div
          className="pl-[16px] lg:pl-[32px] lg:pr-[32px] bg-[#F9F9F9] hidden xl:flex xl:flex-col
          lg:justify-center lg:items-center gap-2"
        >
          <Link to={routesConfig.home}>
            <img src={logo} />
          </Link>
          <p className="text-[18px] xl:mb-7 mt-7 font-medium">Buying online is faster than ever</p>
          <img src={sideImage} className="h-[400px] object-contain" />
        </div>
        <div className="relative pl-[16px] pr-[16px] lg:pl-[32px] lg:pr-[32px] bg-white flex flex-col justify-center items-center animate-growthCenter">
          <Link
            ...
            className="absolute top-[28px] md:top-[40px] left-1/2 -translate-x-1/2 xl:hidden"
          >
            <img src={logo} />
          </Link>
          <form
            ...
            <div className="flex flex-col gap-[24px] xl:gap-[16px]">
              {searchParams.get('registeredEmail') && (
                <div className="flex items-center gap-2 p-3 rounded-md bg-blue-300/15">
                  <p>
                    <InfoIcon className="text-[30px] text-blue-500" />
                  </p>
                  <p className="text-[15px]">
                    An email had been sent to{' '}
                    <a
                      className="font-semibold hover:text-blue-500 transition-all ease-in-out"
              ...
              {searchParams.get('verifiedEmail') && (
                <div className="flex items-center gap-2 p-3 rounded-md bg-green-300/15">
                  ...
                  <p className="text-[15px]">
                    Your email{' '}
                    <span className="font-semibold">{searchParams.get('verifiedEmail')} </span>
